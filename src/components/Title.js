        ...
        <div className="mt-4 ms-5">
          ...
          <div className="ms-2 mt-5">
            ...
            <div className="d-flex">
              ...
              <a href="https://github.com/Phongsathornjan" target="_blank" ><img src={`${process.env.PUBLIC_URL}/icons/github_icon.png`} style={{width: '45px',height: '42px'}} id="icon-hover"/></a>
